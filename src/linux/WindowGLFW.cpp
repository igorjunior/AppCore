...
namespace ultralight
{
  ...
  WindowGLFW::WindowGLFW(Monitor *monitor, const char *name, uint32_t width, uint32_t height,
  ...
  Ref<Window> Window::Create(Monitor *monitor, const char *name, uint32_t width, uint32_t height, bool fullscreen, unsigned int window_flags)
  {
    return AdoptRef(*new WindowGLFW(monitor, name, width, height, fullscreen, window_flags));
  }
