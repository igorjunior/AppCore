...
extern "C"
{
  ...
  ///
  ACExport ULWindow ulCreateWindow(ULMonitor monitor, ULString name, unsigned int width,
  ...
  typedef void (*ULCloseCallback)(void *user_data);
  ...
  typedef void (*ULResizeCallback)(void *user_data, unsigned int width, unsigned int height);
